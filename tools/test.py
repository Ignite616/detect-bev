...
def parse_args():
    ...
    # parser.add_argument('--config', default = 'configs/fastbev/exp/paper/fastbev_m4_r50_s320x880_v250x250x6_c256_d6_f4.py', help='test config file path')
    # parser.add_argument('--checkpoint', default = 'download_model/m4_epoch_20.pth', help='checkpoint file')
...
def main():
    ...
    if rank == 0:
        ...
        if args.eval:
            ...
            print(dataset.evaluate(outputs, vis_mode=args.vis, **eval_kwargs)) # 根据上面预测的box和scores，计算最终的NDS分数
