...
class NuScenesMultiView_Map_Dataset2(NuScenesMultiViewDataset):
    ...
    def __init__(self,
        ...
        self.nusc = NuScenes(version='v1.0-mini', dataroot=self.data_root, verbose=True) # sample:404; 真正加载数据，输出数据集信息
    ...
    def get_data_info(self, index):
        ...
        if 'ann_info' in data_info:
            # get bev segm map
            bev_seg_gt = self._get_map_by_sample_token(sample_token)  # 200, 200, 2 road和line
            ...
            if self.with_box2d:
                ...
                for cam in camera_types:
                    ...
                    coco_infos = get_2d_boxes(self.nusc,
                                              ...
                                              mono3d=False)   
                    for coco_info in coco_infos:   # 对2D标注框做个检查，将在图像范围之外的部分裁减掉
                        ...
                        if coco_info.get('iscrowd', False):  # 该区域是否拥挤
