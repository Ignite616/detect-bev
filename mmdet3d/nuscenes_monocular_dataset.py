        ...
        for i, result in enumerate(results):
            ...
            try:
                ...
                for idx in range(len(labels)):
                    ...
                    bev_pred_img = self.draw_bev_bbox_corner(bev_pred_img, bev_box_pred[idx], pred_bev_color, scale_fac)
            except:
                pass
            ...
            imsave(os.path.join(out_dir, out_file_dir, 'bev_all.png'), mmcv.imrescale(bev_all_img, 0.5))
                ...
                if not len(result['scores_3d']):
                    ...
                    for corner, score, label in zip(corners, scores, labels):
                        ...
                        try:
                            ...
                            self.draw_corners(img_pred, corner, pred_bev_color, projection)
                        except:
                            pass
                    try:
                        # draw GT
                        ...
                        for corner, label in zip(corners, labels):
                            ...
                            self.draw_corners(img_gt, corner, gt_bev_color, projection)
                    except:
                        pass
                out_file_dir = str(i)
            ...
            tmp_img_bottom_pred = np.concatenate(sort_list(img_pred_list[3:6], sort=[2,0,1]) ,axis=1) #TODO:修改为倒数三个
